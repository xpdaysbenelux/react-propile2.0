...
export const eventTitleOptions = [
  {
    ...
    text: translations.getLabel('EVENTS.EVENT_TITLE.WELCOME'),
    value: EventTitle.Welcome,
  },
  {
    key: EventTitle.Registration,
    text: translations.getLabel('EVENTS.EVENT_TITLE.REGISTRATION'),
    value: EventTitle.Registration,
  },
  {
    key: EventTitle.RegistrationAndCoffee,
    text: translations.getLabel('EVENTS.EVENT_TITLE.REGISTRATION_AND_COFFEE'),
    value: EventTitle.RegistrationAndCoffee,
  },
  {
    key: EventTitle.CoffeeBreak,
    text: translations.getLabel('EVENTS.EVENT_TITLE.COFFEE_BREAK'),
    value: EventTitle.CoffeeBreak,
  },
  {
    key: EventTitle.Break,
    text: translations.getLabel('EVENTS.EVENT_TITLE.BREAK'),
    value: EventTitle.Break,
  },
  {
    key: EventTitle.Lunch,
    text: translations.getLabel('EVENTS.EVENT_TITLE.LUNCH'),
    value: EventTitle.Lunch,
  },
  {
    key: EventTitle.Plenary,
    text: translations.getLabel('EVENTS.EVENT_TITLE.PLENARY'),
    value: EventTitle.Plenary,
  },
  {
    key: EventTitle.Closing,
    text: translations.getLabel('EVENTS.EVENT_TITLE.CLOSING'),
    value: EventTitle.Closing,
  },
  {
    key: EventTitle.Dinner,
    text: translations.getLabel('EVENTS.EVENT_TITLE.DINNER'),
    value: EventTitle.Dinner,
  },
  {
    key: EventTitle.ConferenceDinner,
    text: translations.getLabel('EVENTS.EVENT_TITLE.CONFERENCE_DINNER'),
    value: EventTitle.ConferenceDinner,
  },
  {
    key: EventTitle.Drinks,
    text: translations.getLabel('EVENTS.EVENT_TITLE.DRINKS'),
    value: EventTitle.Drinks,
  },
  {
    key: EventTitle.EveningProgramme,
    text: translations.getLabel('EVENTS.EVENT_TITLE.EVENING_PROGRAMME'),
